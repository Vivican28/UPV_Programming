...
public class RecursioString {
    ...
    public static boolean esSufixe(String a, String b) {
        if (a.length() == 0) { return true; }
            ...
            return b.charAt(b.length() - 1) == a.charAt(a.length() - 1)
                && esSufixe(a.substring(0, a.length() - 1), b.substring(0, b.length() - 1));
        }     
    }
    ...
    public static boolean esSubcadena(String a, String b) {
        if (a.length() > b.length()) { return false; }
            ...
            return esSufixe(a, b)
                || esSubcadena(a, b.substring(0, b.length() - 1));
        }
    }
     ...
     * PRECONDICIO: s.length() >= 0 
     */
    public static void inversDesc(String s) {
        if(s.length() != 0) {
           System.out.print(s.charAt(s.length() - 1));
           inversDesc(s.substring(0, s.length() - 1));
        }
        else { System.out.println(); }
    }
    // inversAsc FALTA PER ACABAR
    public static void inversAsc(String s) {
        if(s.length() != 0) {
           inversAsc(s.substring(1));
           System.out.print(s.charAt(s.length() - 1));
