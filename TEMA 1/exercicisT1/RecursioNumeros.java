...
public class RecursioNumeros {
    ...
    // Quantes crides recursives es fan per a obtindre el mcd de 114 i 209
    // amb mcd(114, 209)? i amb euclides(114, 209)?
    ...
    public static double potenciaM(double a, int b) { 
        if (b == 0) { return 1; }
            ...
            double pM = potenciaM(a, b/2);
            if (b % 2 == 0) { return pM * pM; }
            else { return pM * pM * a; }
        }
    }
    ...
    public static int sumaDigits(int n) {
        if (n < 10) { return n; }
        else { return sumaDigits(n / 10) + (n % 10); }
    }
