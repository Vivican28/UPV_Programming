...
public class ProblemesExamQueue {
    ...
    public static void main(String[] args) {
        ...
        QueueIntLinked q5 = new QueueIntLinked();
        // Encuar els valors 1, 2, 3, 4, 5, 6        
        int[] dades9 = {1, 6, 7, 4, 3, 2, 8};        
        for (int i = 0; i < dades9.length; i++) { q5.add(dades9[i]); }  
        System.out.println("q1: " + q5);
        
        QueueIntLinked q8 = removeMajorsQue(q5, 4);
        System.out.println("Després: " + q8);
    }
}
